...
function Pmp() {
  ...
  return (
    <>
      <p>
        The first step in creating a project management plan is to understand how your organization/company/department runs projects. Are there any mandatory resources you are required to use? What resources are already available to you? Are there any similar established projects?
      </p>

      <p>
        This plan is designed to help create a defined path towards the execution, monitor and control and closing process. This plan will help guide you through the rest of the project so it's important to set it up correctly. 
      </p>

      <p>
        This plan is created with some input from key stakeholders. If you are unsure who your stakeholders are, take a second to check out this tutorial: INSERT LINK TO STAKEHOLDERS TUTORIAL. This is also a living document so feel free to re-evaluate certain aspects as your project progresses
      </p>
